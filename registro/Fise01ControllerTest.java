...
import gob.osinergmin.fise.domain.dto.Fise01DTO;
...
import gob.osinergmin.fise.service.Fise01Service;
...
public class Fise01ControllerTest {
	
	{
		...
		when(PropertiesUtils.getMessagesProperty("fise01.excepcion.enviar")).thenReturn("error");
		
		
	}
	
	@InjectMocks
	Fise01Controller fise01Controller = new Fise01Controller();
	...
	@Mock
	private Fise01Service fise01Service;
	...
	public void enviarLoteManualConId() throws Exception{
		...
		when(fise01Service.enviarLoteManual((LoteDTO)anyObject(), (List<Fise01DTO>)anyObject(), (ArchivoDTO)anyObject())).thenReturn(1);
		
		Map<String, ? extends Object>  result = fise01Controller.enviarLoteManual(request);
