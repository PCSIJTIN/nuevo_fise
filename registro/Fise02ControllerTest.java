...
import gob.osinergmin.fise.domain.dto.Fise02DTO;
...
import gob.osinergmin.fise.service.Fise02Service;
...
public class Fise02ControllerTest {
	
	{
		...
		when(PropertiesUtils.getMessagesProperty("fise02.excepcion.enviar")).thenReturn("error");
		
	}
	
	@InjectMocks
	Fise02Controller fise02Controller = new Fise02Controller();
	...
	@Mock
	private Fise02Service fise02Service;
	...
	public void enviarLoteManualConId() throws Exception{
		...
		when(fise02Service.enviarLoteManual((LoteDTO)anyObject(), (List<Fise02DTO>)anyObject(), (ArchivoDTO)anyObject())).thenReturn(1);
		
		Map<String, ? extends Object>  result = fise02Controller.enviarLoteManual(request);
